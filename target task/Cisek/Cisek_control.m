...
[perc_overPDOD,perc_overPD,perc_overOD,...
    perc_overPDOD1,perc_overPD1,perc_overOD1] = deal(zeros(length(alldays(1).PMd_units),1));
...
%         end
        ...
        od_trials = rast_bin(odonly,2);
%         yS_odonly = zeros(size(od_trials,1),51);
...
%         end
        ...
        o_trials = rast_bin(orth,2);
%         yS_o = zeros(size(o_trials,1),51);
