function[PD,PD_bounds,PD_dists,MAG_dists,curve_params] = PD_tuning_VM(spikes,angles,comp_tt,t1,t2,alignment,neuron,speeds,bootstrapnum,bounds,varargin)
...
[~,curve_params] = PD_helper_func(input_mat);
if nargin > 8
    [~,~,~,rand_boot] = boot_bounds(bootstrapnum, @PD_MAG_helper_func, input_mat,bounds(1),bounds(2));
