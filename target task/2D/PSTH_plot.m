function[rasters, fig_hand, graph_objs, kin] = PSTH_plot(bdf,train,trial_table,t1_t2,WindowBin,alignment,colorofplot,varargin)
%%%
...
if nargin > 6
    ...
    plot(wincents, bincounts_H , 'Color',colorofplot);
    patch([wincents fliplr(wincents)],...
        [bincounts_H - 1.96*bincount_SE_H, fliplr(bincounts_H + 1.96*bincount_SE_H)],colorofplot,'FaceAlpha',0.4,'EdgeAlpha',0.1);

elseif length(unique(trial_table(:,3)))>1
