...
session_limit = 10e10;
%%
[FL, FU, FM, RB, BPDS, split_indices,KRATS, PRIS] = ...
...
%     alldays(2).tt = alldays(2).tt(ISNew{daynum},:);
    ...
    clearvars -except FL FU FM FileName RB VA BPDS BRAIN_AREA G counter PLR ...
        split_indices std_priors std_likes std_posts LI PLRb session_limit loop_ranges KRATS PRIS dRES_PMd dRES_M1 ISNew;
